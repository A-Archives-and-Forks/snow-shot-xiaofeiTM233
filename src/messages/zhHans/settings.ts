export const settings = {
	...
	"settings.systemSettings.networkSettings.pluginDownloadSources": "插件下载源",
	...
	"settings.functionSettings.screenshotSettings.windowAutoSelectBlacklist.tip":
		"在黑名单中的窗口在截图时不会被自动框选，需输入完整的窗口标题进行匹配，可用于排除公司水印等软件的干扰",
	...
	"settings.hotKeySettings.fixedContent": "贴图",
	...
	"settings.hotKeySettings.fixedContent.fixedContentShowBorder": "显示边框",
	...
	"settings.hotKeySettings.fixedContent.fixedContentSelectText":
		"选取文本/拖拽窗口",
	"settings.functionSettings.fixedContentSettings": "贴图",
